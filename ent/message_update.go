...
func (mu *MessageUpdate) SetType(mt message.MessageType) *MessageUpdate {
	mu.mutation.SetType(mt)
	return mu
}
...
// SetType sets the "type" field.
func (muo *MessageUpdateOne) SetType(mt message.MessageType) *MessageUpdateOne {
	muo.mutation.SetType(mt)
	return muo
}
